...
def main(temp1=None):
    ...
    ma,mb, D, timematching = AlignNetworks_EigenAlign.align_networks_eigenalign(G1, G2, 8, "lowrank_svd_union", 3)
    mb=np.array(mb,int)
    recovery = evaluate_erdosreyni_experiment(G1, G2, ma, mb)
    print(recovery)
